...
\newcommand{\geantiv}{\texttt{Geant\uppercase\expandafter{\romannumeral 4}}}
...
% \faLinkedin, \faStackExchange, \faStackOverflow \faTwitter, ...
% see also: https://github.com/xdanaux/moderncv/blob/master/moderncviconsawesome.sty 
